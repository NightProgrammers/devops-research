...
*/}}
{{- define "tide.roleName" -}}
{{- if .Values.serviceAccount.roleBinding.create }}
{{- default (include "tide.fullname" .) .Values.serviceAccount.roleBinding.role }}
{{- end }}
{{- end }}
...
*/}}
{{- define "tide.roleBindingName" -}}
{{- if .Values.serviceAccount.roleBinding.create }}
{{- default (include "tide.fullname" .) .Values.serviceAccount.roleBinding.name }}
{{- end }}
{{- end }}